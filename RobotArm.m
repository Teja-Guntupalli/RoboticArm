...
% Last Modified by GUIDE v2.5 02-Jun-2015 22:20:06
...
% --- Executes on button press in PickPlace.
function PickPlace_Callback(hObject, eventdata, handles)
% hObject    handle to PickPlace (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
PickPlaceGUI();
end
...
% --- Executes on button press in Belt_IR.
function Belt_IR_Callback(hObject, eventdata, handles)
% hObject    handle to Belt_IR (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
PickPlaceGUI_IR();
end
...
% --- Executes on button press in Belt_IR_Color.
function Belt_IR_Color_Callback(hObject, eventdata, handles)
% hObject    handle to Belt_IR_Color (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
PickPlaceGUI_IR_Color();
end
