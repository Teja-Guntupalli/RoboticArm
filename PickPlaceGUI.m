function varargout = PickPlaceGUI(varargin)
%PICKPLACEGUI M-file for PickPlaceGUI.fig
%      PICKPLACEGUI, by itself, creates a new PICKPLACEGUI or raises the existing
%      singleton*.
%
%      H = PICKPLACEGUI returns the handle to a new PICKPLACEGUI or the handle to
%      the existing singleton*.
%
%      PICKPLACEGUI('Property','Value',...) creates a new PICKPLACEGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to PickPlaceGUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      PICKPLACEGUI('CALLBACK') and PICKPLACEGUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in PICKPLACEGUI.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help PickPlaceGUI

% Last Modified by GUIDE v2.5 11-Jun-2015 18:14:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @PickPlaceGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @PickPlaceGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before PickPlaceGUI is made visible.
function PickPlaceGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for PickPlaceGUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes PickPlaceGUI wait for user response (see UIRESUME)
...
function varargout = PickPlaceGUI_OutputFcn(hObject, eventdata, handles)
