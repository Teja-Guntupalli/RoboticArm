function varargout = PickPlaceGUI_IR_Color(varargin)
%PICKPLACEGUI_IR_COLOR M-file for PickPlaceGUI_IR_Color.fig
%      PICKPLACEGUI_IR_COLOR, by itself, creates a new PICKPLACEGUI_IR_COLOR or raises the existing
%      singleton*.
%
%      H = PICKPLACEGUI_IR_COLOR returns the handle to a new PICKPLACEGUI_IR_COLOR or the handle to
%      the existing singleton*.
%
%      PICKPLACEGUI_IR_COLOR('Property','Value',...) creates a new PICKPLACEGUI_IR_COLOR using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to PickPlaceGUI_IR_Color_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      PICKPLACEGUI_IR_COLOR('CALLBACK') and PICKPLACEGUI_IR_COLOR('CALLBACK',hObject,...) call the
%      local function named CALLBACK in PICKPLACEGUI_IR_COLOR.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help PickPlaceGUI_IR_Color

% Last Modified by GUIDE v2.5 11-Jun-2015 20:55:25

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @PickPlaceGUI_IR_Color_OpeningFcn, ...
                   'gui_OutputFcn',  @PickPlaceGUI_IR_Color_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before PickPlaceGUI_IR_Color is made visible.
function PickPlaceGUI_IR_Color_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for PickPlaceGUI_IR_Color
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes PickPlaceGUI_IR_Color wait for user response (see UIRESUME)
...
function varargout = PickPlaceGUI_IR_Color_OutputFcn(hObject, eventdata, handles)
